...
value.stage = string(localField(record, "stage", ""));
value.stageRole = string(localField(record, "stageRole", ""));
value.stageIteration = localField(record, "stageIteration", 0);
...
value.loopValidations = localField(validation, "loopValidations", []);
